...
<body class="min-h-screen flex flex-col justify-center items-center bg-gray-50 px-4">
    ...
    <img src="{{ url("imgs/amplimed.png")}}" class=" w-80 mx-auto" alt="">
        ...
        <a href="{{ route('login') }}"
            class="inline-block bg-purple-600 hover:bg-purple-800 text-white font-semibold px-8 py-3 rounded-full shadow transition focus:outline-none focus:ring-2 focus:ring-purple-400">
            Entrar
        </a>
